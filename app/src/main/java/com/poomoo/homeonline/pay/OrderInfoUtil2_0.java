...
public class OrderInfoUtil2_0 {
     ...
     * @return
     */
    public static Map<String, String> buildOrderParamMap(String app_id, String total_amount, String subject, String body, String out_trade_no) {
        ...
        keyValues.put("notify_url", NetConfig.RemoteUrl + "jyzx/app/pay/alipay_notify.html");
