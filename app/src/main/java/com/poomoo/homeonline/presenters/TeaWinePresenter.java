 ...
 * 日期 2017/1/18 16:51
 */
public class TeaWinePresenter extends BasePresenter<TeaWineActivity> {
    @Inject
    public TeaWinePresenter() {
    }

    public void getInfo(int categoryId) {
        QTypeBO qTypeBO = new QTypeBO(NetConfig.TEAWINE, -1, categoryId);
