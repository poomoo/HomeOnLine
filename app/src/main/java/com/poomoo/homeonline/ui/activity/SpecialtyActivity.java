 ...
 * 日期 2017/1/13 15:17
 */
public class SpecialtyActivity extends BaseDaggerActivity<NewSpecialPresenter> implements BaseListAdapter.OnItemClickListener, ErrorLayout.OnActiveClickListener {
...
//            infoAdapter.clear();
            ...
            mPresenter.getInfo(1, categoryId);
            mErrorLayout.setState(ErrorLayout.LOADING, "");
        });
//        titleAdapter.setItems(getTitleList());

        listRecycler.setLayoutManager(new ScrollLinearLayoutManager(this));
        infoAdapter = new SpecialtyListCommodityAdapter(this, BaseListAdapter.NEITHER, SPECIALTY, position -> {//加入购物车
